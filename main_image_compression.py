...
def main_image_compression():
    ...
    list_sorted_by_color = list_of_the_words_in_file_sorted_according_to_length(list_of_union_the_shades_of_pixels,
                                                                                length_word)
    ...
    list_of_keywords, short_list_of_union_the_shades_of_pixels, radius = affiliation_to_groups(list_sorted_by_color,
                                                                                               list_of_union_the_shades_of_pixels.__len__(),
                                                                                               length_word)
